...
contract MasterChef is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        reward = _reward; // 0x80b5a32E4F032B2a058b4F29EC95EEfEEB87aDcd
        rewardPerBlock = _rewardPerBlock; // wei 1000000000000
        startBlock = _startBlock; // fxcore height (block height)
        totalAllocPoint = 0;
        BONUS_MULTIPLIER = 1;
